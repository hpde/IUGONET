[![SPASE Monthly Validation](https://github.com/hpde/IUGONET/actions/workflows/validate-schedule.yml/badge.svg)](https://github.com/hpde/IUGONET/actions/workflows/validate-schedule.yml)
[![SPASE Push Validation](https://github.com/hpde/IUGONET/actions/workflows/validate-push.yml/badge.svg)](https://github.com/hpde/IUGONET/actions/workflows/validate-push.yml)

# IUGONET

Inter-university Upper atmosphere Global Observation NETwork (IUGONET).

SPASE resource descriptions with the IUGONET naming authority.
...
````
git clone git@github.com:hpde/IUGONET.git
````
